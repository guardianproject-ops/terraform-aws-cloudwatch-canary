...
# terraform-aws-cloudwatch-canary
...
Instead pin to the release tag (e.g. `?ref=tags/x.y.z`) of one of our [latest releases](https://gitlab.com/guardianproject-ops/terraform-aws-cloudwatch-canary/-/tags).
...
File an [issue](https://gitlab.com/guardianproject-ops/terraform-aws-cloudwatch-canary/issues), send us an [email][email] or join us in the Matrix 'verse at [#guardianproject:matrix.org][matrix] or IRC at `#guardianproject` on Freenode.

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://gitlab.com/guardianproject-ops/terraform-aws-cloudwatch-canary/issues) to report any bugs or file feature requests.
